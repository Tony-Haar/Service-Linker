  ...
  mechanic: [
    {
      ...
      rating: 4.5,
      phone: 7234567890,
      service: "I will repair and maintain your vehicle with precision.",
      price: 200 + " INR",
      distance: 2.5 + " km",
    },
    {
      ...
      rating: 4.0,
      phone: 9087654321,
      service: "I specialize in engine diagnostics and repairs.",
      price: 230 + " INR",
      distance: 1.5 + " km",
    },

    {
      ...
      rating: 4.7,
      phone: 6789012345,
      service: "Experienced mechanic for all types of vehicles.",
      price: 150 + " INR",
      distance: 3.5 + " km",
    },
    {
      ...
      rating: 4.6,
      phone: 8901234567,
      service: "Car maintenance and repair services.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
  ],
  plumber: [
    {
      ...
      rating: 4.8,
      phone: 7890123456,
      service: "I will help you out with everything plumbing.",
      price: 200 + " INR",
      distance: 2.5 + " km",
    },
    {
      ...
      rating: 4.0,
      phone: 6789012345,
      service: "Expert in residential and commercial plumbing.",
      price: 150 + " INR",
      distance: 1.5 + " km",
    },
    {
      ...
      rating: 3.9,
      phone: 8901234567,
      service: "Affordable plumbing services for your home.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
    {
      ...
      rating: 4.5,
      phone: 8901234567,
      service: "Quality plumbing services for your home.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
  ],
  painter: [
    {
      ...
      rating: 4.8,
      phone: 7890123456,
      service: "Expert in interior and exterior painting.",
      price: 200 + " INR",
      distance: 2.5 + " km",
    },
    {
      ...
      rating: 4.5,
      phone: 6789012345,
      service: "Professional painting services for your home.",
      price: 150 + " INR",
      distance: 1.5 + " km",
    },
    {
      ...
      rating: 4.7,
      phone: 8901234567,
      service: "Quality painting services at affordable prices.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
    {
      ...
      rating: 4.6,
      phone: 8901234567,
      service: "Professional and reliable painting services.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
  ],
  carpenter: [
    {
      ...
      rating: 4.9,
      phone: 7890123456,
      service: "Custom carpentry services for all your needs.",
      price: 200 + " INR",
      distance: 2.5 + " km",
    },

    {
      ...
      rating: 4.4,
      phone: 6789012345,
      service: "Expert carpenter for furniture and fittings.",
      price: 150 + " INR",
      distance: 1.5 + " km",
    },
    {
      ...
      rating: 4.6,
      phone: 8901234567,
      service: "Professional carpentry services for your home.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
    {
      ...
      rating: 4.2,
      phone: 8901234567,
      service: "Expert in home and office carpentry.",
      price: 300 + " INR",
      distance: 4.5 + " km",
    },
  ],
...
export const services = [
  {
    id: 1,
    name: "Carpentry",
    description: "Repair or replace wooden fixtures and structures.",
    image: carpentry,
  },
  {
    id: 2,
    name: "Electrical",
    description: "Repair faulty wiring, outlets, and lighting issues.",
    image: electrical,
  },
  {
    id: 3,
    name: "Plumbing",
    description: "Fix leaks, broken pipes, and clogged drains.",
    image: plumbing,
  },
  {
    id: 4,
    name: "Sanitation",
    description: "Install and repair plumbing fixtures and systems.",
    image: sanitation,
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    name: "Roofing",
    description: "Fix leaks, missing shingles, and structural issues.",
    image: roofing,
  },
  {
    id: 7,
    name: "Mechanical",
    description: "Repair or replace mechanical systems and equipment.",
    image: mechanical,
  },
];
