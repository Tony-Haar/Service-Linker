...
const UserChats = ({ messages, sendMessage }) => {
  ...
  const filteredMessages = selectedSender
    ? messages.filter(
        (msg) => msg.sender === selectedSender || msg.sender === "User"
      )
    : [];
...
return (
    <>
        ...
        <div className="container d-flex flex-column flex-md-row justify-content-center">
            <div className="sidebar p-4 rounded mb-4 mb-md-0 vh-100 border border-secondary bg-warning">
                <div className="sidebarTitle">
                    <h1 className="text-primary">User Chat</h1>
            ...
            <div className="mainScreen p-4 rounded vh-100 border border-secondary flex-grow-1 d-flex flex-column bg-info">
